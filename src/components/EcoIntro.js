...
export default function InrtoEco() {
    ...
    return (
        <section className="relative  justify-center  w-full items-center  grid-rows-6 grid-cols-12 sm:pb-5 h-[100vh] xl:h-[130vh] xl:pb-10 max-w-[100vw] " ref={introRef} >


            <div className="absolute md:top-[-15%]  top-[-20%] xl:top-[-5%] z-0 flex-auto  items-center ">
                <img src={web} alt="web" className="im-size firefox xl:h-[120vh]" />
            </div>
