        ...
        <nav className="py-2 z-40  bg-opacity-0 ">
            <div className="max-w-full mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex justify-between h-16">
                    <div className="flex">
                        <div className="flex-shrink-0 flex items-center lg:pr-96">
                            <a>
