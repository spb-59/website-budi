    ...
    return (
        <><section id="Services" className="sm:pt-5 relative pb-0 lg:pt-10  bg-opacity-[80%]">
            ...
            <div className=" flex md:min-h-[60vh] flex-col ">
                <div className="md:row-start-1  md:col-start-3  text-[14px] sm:text-[32px] xl:text-[48px]  font-bold md:col-span-6 col-span-full row-span-full flex flex-col items-center gap-0 pt-0  pb-10 ">
...
function innerElem() {
    ...
    return (
        ...
        <>
            <div className=" md:grid-rows-4 md:grid-cols-7 gap-4 md:gap-0 md:hidden text-center gap-5" >

                <div className="md:col-start-2 md:row-start-1    flex flex-col md:col-span-1 md:row-span-2  items-center pb-10">
                    <div className="flex md:text-[20px] text-[16px] font-bold  items-center text-color justify-center text-center md:items-start w-4/5 ">
            ...
            <div className="hidden items-center justify-center md:flex w-full ">
                <div className="flex flex-row flex-wrap w-3/4 items-center h-full md:text-balance">
                    ...
                    <div className="w-1/2 flex flex-col py-px items-center lg:h-[35vh] md:h-[45vh]">
                        ...
                        <div className="flex md:text-[20px] text-[16px] font-bold  items-start text-color text-left md:items-start h-2/5 w-3/5  ">

                            Eliminate Cart Abandonment to Zero
                        </div>
                        <div className="flex md:text-[12px] text-[16px]  w-3/5 md:w-3/5   items-start    h-full">
...
{/* 
                    <div className="w-1/2 flex flex-col py-px items-center lg:h-[35vh] md:h-[45vh]">
                        ...
                        <div className="flex md:text-[20px] text-[16px] font-bold  items-center text-color justify-center text-center md:items-start h-2/5 w-3/4  ">
